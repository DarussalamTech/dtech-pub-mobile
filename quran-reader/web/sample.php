...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
    <head>
        ...
        <script type="text/javascript">
            var pdf_file = "<?php echo $_GET['pdf_file']; ?>";
                ...
                <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                    <div id="secondaryToolbarButtonContainer">
                        <button id="secondaryPresentationMode" class="secondaryToolbarButton presentationMode visibleLargeView" title="Switch to Presentation Mode" tabindex="19" data-l10n-id="presentation_mode">
                            <span data-l10n-id="presentation_mode_label"></span>
                        </button>
                        ...
                        <a href="#" id="secondaryViewBookmark" class="secondaryToolbarButton bookmark visibleSmallView" title="Current view (copy or open in new window)" tabindex="23" data-l10n-id="bookmark">
                            <span data-l10n-id="bookmark_label"></span>
                        </a>
                        ...
                        <button id="pageRotateCw" class="secondaryToolbarButton rotateCw" title="Rotate Clockwise" tabindex="26" data-l10n-id="page_rotate_cw">
                            <span data-l10n-id="page_rotate_cw_label"></span>
                        </button>
                        <button id="pageRotateCcw" class="secondaryToolbarButton rotateCcw" title="Rotate Counterclockwise" tabindex="27" data-l10n-id="page_rotate_ccw">
                            <span data-l10n-id="page_rotate_ccw_label"></span>
                        </button>
                    ...
                    <div id="toolbarContainer">
                        <div id="toolbarViewer">
                            ...
                            <div id="toolbarViewerRight">
                                <input type='hidden' id="presentationMode" class="toolbarButton presentationMode hiddenLargeView" title="Switch to Presentation Mode" tabindex="13" data-l10n-id="presentation_mode">
                                  <!--<span data-l10n-id="presentation_mode_label"></span>-->
                                </input>

                                <input type='hidden' id="openFile" class="toolbarButton openFile hiddenLargeView" title="Open File" tabindex="14" data-l10n-id="open_file">
                                  <!--<span data-l10n-id="open_file_label"></span>-->
                                </input>

                                <input type='hidden' id="print" class="toolbarButton print hiddenMediumView" title="Print" tabindex="15" data-l10n-id="print">
                                  <!--<span data-l10n-id="print_label"></span>-->
                                </input>

                                <input type='hidden' id="download" class="toolbarButton download hiddenMediumView" title="Download" tabindex="16" data-l10n-id="download">
                                  <!--<span data-l10n-id="download_label"></span>-->
                                </input>
                                <!-- <div class="toolbarButtonSpacer"></div> -->
                                ...
                                <input type='hidden' id="secondaryToolbarToggle" class="toolbarButton" title="" tabindex="18" data-l10n-id="tools">
                                  <!--<span data-l10n-id="tools_label"></span>-->
                                </input> 
                            </div>
